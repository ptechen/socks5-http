// use socks5_client::{UdpClientImpl, protocol::UserKey, Result};
// use std::{
...
// pub struct CmdOpt {
//     /// Udp target socks5_server address.
...
//     data: String,
//
//     /// Via socks5 proxy socks5_server.
//     #[clap(short, long)]
//     via_proxy: bool,
//
//     /// Socket5 proxy socks5_server address.
//     #[clap(short, long, value_name = "addr:port")]
